        ...
        <div className="max-w-4xl mx-auto bg-white/80 backdrop-blur-sm p-8 rounded-lg">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              ...
              hands. Since then, I&apos;ve been exploring different techniques
            ...
            <p>
              I believe that handmade items carry a special energy -
              they&apos;re not just products, but pieces of art that tell a
              story. Each item I create is made with attention to detail and
              love for the craft.
            </p>
          </div>
        </div>
