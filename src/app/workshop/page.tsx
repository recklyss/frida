      ...
      <div className="max-w-4xl mx-auto bg-white/80 backdrop-blur-sm p-8 rounded-lg">
        ...
        <div className="grid gap-8 md:grid-cols-3 mb-12">
          ...
          <div className="p-6 bg-white/60 backdrop-blur-sm rounded-lg text-center">
            ...
            <p className="text-gray-600">
              Browse and book upcoming crafting workshops
            </p>
          </div>
          ...
          <div className="p-6 bg-white/60 backdrop-blur-sm rounded-lg text-center">
            ...
            <p className="text-gray-600">
              Learn various crafting techniques in person
            </p>
          </div>
          ...
          <div className="p-6 bg-white/60 backdrop-blur-sm rounded-lg text-center">
            ...
            <p className="text-gray-600">
              Simple sign-up process for all workshops
            </p>
          </div>
        </div>
        ...
        <div className="text-center p-8 bg-white/60 backdrop-blur-sm rounded-lg">
          ...
          <p className="mb-6 text-gray-600">
            Be the first to know when workshop registration opens! Follow me on
          ...
          <div className="flex justify-center gap-4">
            <Link
              ...
              className="p-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full hover:opacity-90 transition-opacity"
